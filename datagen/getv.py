...
def samplefunc():
    f = open('/home/jps8/datagen/games.pgn')
    b1 = []
    b2 = []
    l1 = []
    l2 = []
    ...
    name1 =str("./b1_" + (str(data_num)) + (".tensor"))
